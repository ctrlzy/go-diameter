    ...
    <application id="16777217" type="auth" name="TGPP Sh">
        ...
        <command code="306" short="UD" name="User-Data">
            <request>
                ...
                <rule avp="Current-Location" max="1" required="false"/>
                <rule avp="DSAI-Tag" required="false"/>
                <rule avp="Session-Priority" max="1" required="false"/>
                <rule avp="User-Name" max="1" required="false"/>
                <rule avp="Requested-Nodes" max="1" required="false"/>
                <rule avp="Serving-Node-Indication" max="1" required="false"/>
                <rule avp="Pre-paging-Supported" max="1" required="false"/>
                <rule avp="Local-Time-Zone-Indication" max="1" required="false"/>
                <rule avp="UDR-Flags" max="1" required="false"/>
                <rule avp="Call-Reference-Info" max="1" required="false"/>
        ...
        <command code="307" short="PU" name="Profile-Update">
            ...
            <answer>
                ...
                <rule avp="Wildcarded-Public-Identity" max="1" required="false"/>
                <rule avp="Wildcarded-IMPU" max="1" required="false"/>
                <rule avp="Repository-Data-ID" max="1" required="false"/>
                <rule avp="Data-Reference" max="1" required="false"/>
                <rule avp="Supported-Features" required="false"/>
                <rule avp="OC-Supported-Features" max="1" required="false"/>
                <rule avp="OC-OLR" max="1" required="false"/>
                <rule avp="Failed-AVP" max="1" required="false"/>
        ...
        <command code="308" short="SN" name="Subscribe-Notifications">
            <request>
                ...
                <rule avp="Wildcarded-IMPU" max="1" required="false"/>
                <rule avp="Service-Indication" required="false"/>
                <rule avp="Send-Data-Indication" max="1" required="false"/>
                <rule avp="Server-Name" max="1" required="false"/>
                ...
                <rule avp="DSAI-Tag" required="false"/>
                <rule avp="One-Time-Notification" max="1" required="false"/>
                <rule avp="User-Name" max="1" required="false"/>
                <rule avp="OC-Supported-Features" max="1" required="false"/>
                <rule avp="Proxy-Info" required="false"/>
                <rule avp="Route-Record" required="false"/>
        ...
        <avp name="Data-Reference" code="703" may-encrypt="N" must="M,V" vendor-id="10415">
            <data type="Enumerated">
                ...
                <item code="2" name="Undefined"/>
                <item code="3" name="Undefined"/>
                <item code="4" name="Undefined"/>
                <item code="5" name="Undefined"/>
                <item code="6" name="Undefined"/>
                <item code="7" name="Undefined"/>
                <item code="8" name="Undefined"/>
                <item code="9" name="Undefined"/>
